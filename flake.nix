  ...
  outputs = {
      ...
      forAllSystems = function:
        nixpkgs.lib.genAttrs [
          ...
          "aarch64-darwin"
            ...
            rasm = craneLib.buildPackage (craneCommon
              // {
    ...
    in {
      checks = forAllSystems ({
        ...
        rasm-clippy = craneLib.cargoClippy (craneCommon
          // {
            inherit cargoArtifacts;
        ...
        # Check formatting
        rasm-fmt = craneLib.cargoFmt {
          inherit src;
        };

        # Audit dependencies
        rasm-audit = craneLib.cargoAudit {
      ...
      apps = forAllSystems ({system, ...}: {
        rasm = {
          type = "app";
          program = "${self.packages.${system}.rasm}/bin/rasm";
        };
        default = self.apps.${system}.rasm;
      });
